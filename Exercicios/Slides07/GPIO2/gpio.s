...
; 3. Limpar PCTL para selecionar o GPIO
    ...
    LDR     R0, =GPIO_PORTJ_AHB_PCTL_R      ;Carrega o R0 com o endereço do PCTL para a porta F
...
; 4. DIR para 0 se for entrada, 1 se for saída
    ...
    LDR     R0, =GPIO_PORTN_AHB_DIR_R		;Carrega o R0 com o endereço do DIR para a porta J
    MOV     R1, #2_00000010            		;Colocar 0 no registrador DIR para funcionar com saída
    STR     R1, [R0]						;Guarda no registrador PCTL da porta J da memória
...
;    Sem função alternativa
    ...
    LDR     R0, =GPIO_PORTN_AHB_AFSEL_R     ;Carrega o endereço do AFSEL da porta J
    STR     R1, [R0]                        ;Escreve na porta
; 6. Setar os bits de DEN para habilitar I/O digital
    LDR     R0, =GPIO_PORTJ_AHB_DEN_R			;Carrega o endereço do DEN
    MOV     R1, #2_00000001                     ;Ativa os pinos PF0 e PF4 como I/O Digital
    STR     R1, [R0]							;Escreve no registrador da memória funcionalidade digital 
 
    LDR     R0, =GPIO_PORTN_AHB_DEN_R			;Carrega o endereço do DEN
	MOV     R1, #2_00000010                     ;Ativa os pinos PJ0 e PJ1 como I/O Digital      
    STR     R1, [R0]                            ;Escreve no registrador da memória funcionalidade digital
