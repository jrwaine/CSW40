...
void GPIO_Init(void)
{
    ...
    // 9. Ativa ADC (conversor A/D)
    SYSCTL_RCGCADC_R = SYSCTL_RCGCADC_R0;
    while(SYSCTL_PRADC_R != SYSCTL_RCGCADC_R0);
    ADC0_PC_R = ADC_PC_MCR_FULL;
    ADC0_SSPRI_R = 0x0123;
    ADC0_ACTSS_R = ADC0_ACTSS_R & (~0x4);
...
int converteAD(void)
{
    ...
    int var = ADC0_SSFIFO3_R;
    ADC0_ISC_R = ADC0_ISC_R | 0x8;
    return var;
}
